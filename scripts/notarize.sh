...
keychain_profile="komutracker-$APPLE_PERSONALID"  # name of the keychain profile to use
bundleid=net.komutracker.KomuTracker # Match aw.spec
app=dist/KomuTracker.app
dmg=dist/KomuTracker.dmg
